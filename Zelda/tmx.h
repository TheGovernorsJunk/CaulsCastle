...
namespace te
{
	...
	public:
		...
		void makeVertices(TextureManager& textureManager, std::vector<const sf::Texture*>& textures, std::vector<std::vector<sf::VertexArray>>& layers, int widthUnitsPerTile = 0, int heightUnitsPerTile = 0) const;
